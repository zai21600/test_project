...
public class authorBookView {
	...
	@GET
	public Response getAuthorTable(@DefaultValue("") @QueryParam("author") String author) throws SQLException, NamingException, ClassNotFoundException   {
		Connection db = MySQLConnUtils.getMySQLConnection();
		System.out.println(author);
		try {
			JsonArrayBuilder jsonArray =Json.createArrayBuilder();
			PreparedStatement st = db.prepareStatement(
					"Select a.book_name, a.author , a.chapter, a.content from book a WHERE a.author = ?"
					);
